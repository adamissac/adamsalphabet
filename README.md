...
│       └── [unit]/page.tsx         # Dynamic unit page (all 7 units)
...
├── data/
│   └── units.ts                    # Curriculum source of truth
└── hooks/
...
Free educational use. Not affiliated with Khan Academy, GADOE, or any specific school district.
